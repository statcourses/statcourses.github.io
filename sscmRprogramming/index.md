...
## Prerequisite
<p align="justify">
<strong>This course is an integrated part of the <a href="{{ site.baseurl}}/sscmIntro-to-R"><strong>'Introduction to R'</strong></a> course</strong>. Both courses together, "Introduction to R" and this course, form a series titled '<em>Mastering Data Analysis & Visualisation Using R</em>'. <u>It is assumed that all participants have the knowledge covered by the former course</u>.
</p>
